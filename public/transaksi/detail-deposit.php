<?php
   ...
   $deposito = getDataFromDatabase($depositoDb, "SELECT * FROM deposito WHERE deposito_id = '$depositoId'");
   if (empty($deposito)) {
      header("location:/public/deposit.php");
      exit;
   }
   ...
   <div class="max-w-3xl mx-auto min-h-screen bg-white overflow-hidden">
      ...
      <main class="p-5">
         <div class="flex flex-col gap-5">
            ...
            <?php if ($deposito[0]["status"] === 0) : ?>
               <!-- pesan -->
               <div class="p-5 bg-gradient-to-b from-white to-gray-100 border shadow-md shadow-gray-200 rounded">
                  <div class="w-fit">
                     <span>Kami akan segera mengirim informasi pembayaran ke nomor kamu melalui WhatsApp.</span>
                  </div>
               </div>
            <?php endif; ?>
               ...
               <div class="p-5 bg-white border-b">
                  <div class="flex items-center justify-center">
                     <div class="w-fit mx-auto text-center">
                        <span class="font-semibold">Detail Deposit</span>
                     </div>
                  </div>
               </div>
               <div class="p-5">
                  <div class="flex flex-col">
                     <div class="py-3 bg-gray-50 border-b">
                        <div class="flex items-center justify-between gap-5">
                           ...
                           <span class="font-semibold">#<?= htmlspecialchars($deposito[0]["deposito_id"]); ?></span>
                        </div>
                     </div>
                     <div class="py-3 border-b">
                        <div class="flex items-center justify-between gap-5">
                           <span>Jumlah Deposit</span>
                           <span class="font-semibold"><?= htmlspecialchars($deposito[0]["amount"]); ?></span>
                        </div>
                     </div>
                     <div class="py-3 bg-gray-50 border-b">
                        <div class="flex items-center justify-between gap-5">
                           <span>Total Pembayaran</span>
                           <span class="font-semibold">IDR <?= htmlspecialchars(number_format($deposito[0]["amount"] + 0, 0, ",", ".")); ?></span>
                        </div>
                     </div>
                     <div class="py-3 border-b">
                        <div class="flex items-center justify-between gap-5">
                           ...
                           <?php elseif ($deposito[0]["status"] === 1) : ?>
                     ...
                     <div class="py-3 border-b">
                        <div class="flex items-center justify-between gap-5">
                           <span>Waktu Deposit</span>
                           <span class="font-semibold"><?= htmlspecialchars($deposito[0]["time"]); ?></span>
                        </div>
                     </div>
                  </div>
               </div>
