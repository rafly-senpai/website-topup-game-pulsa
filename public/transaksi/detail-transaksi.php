<?php
   ...
   if (str_contains($transactionId, "'")) {
      header("location:/public/riwayat-transaksi.php");
      exit;
   }
   ...
   $transaction = getDataFromDatabase($transactionsDb, "SELECT * FROM transactions WHERE transaction_id = '$transactionId'");
               ...
               <div class="p-5 bg-white border-b">
                  <div class="flex items-center justify-center">
                     <div class="w-fit mx-auto text-center">
                        <span class="font-semibold">Detail Transaksi</span>
                     </div>
                  </div>
               </div>
               <div class="p-5">
                  <div class="flex flex-col">
                     <div class="py-3 bg-gray-50 border-b">
                        <div class="flex items-center justify-between gap-5">
                           ...
                           <span class="font-semibold">#<?= htmlspecialchars($transaction[0]["transaction_id"]); ?></span>
                        </div>
                     </div>
                     <div class="py-3 border-b">
                        <div class="flex items-center justify-between gap-5">
                           <span>Produk</span>
                           <span class="font-semibold"><?= htmlspecialchars(strtoupper($transaction[0]["product"])); ?></span>
                        </div>
                     </div>
                     <div class="py-3 bg-gray-50 border-b">
                        <div class="flex items-center justify-between gap-5">
                           <span>Item</span>
                           <span class="font-semibold"><?= htmlspecialchars($transaction[0]["item"]); ?></span>
                        </div>
                     </div>
                     <div class="py-3 border-b">
                        <div class="flex items-center justify-between gap-5">
                           <span>Harga</span>
                           <span class="font-semibold">IDR <?= htmlspecialchars(number_format($transaction[0]["price"], 0, ",", ".")); ?></span>
                        </div>
                     </div>
                     <div class="py-3 bg-gray-50 border-b">
                        <div class="flex items-center justify-between gap-5">
                           <span>Data Tujuan</span>
                           <span class="font-semibold"><?= htmlspecialchars($transaction[0]["to"]); ?></span>
                        </div>
                     </div>
                     <div class="py-3 border-b">
                        <div class="flex items-center justify-between gap-5">
                     ...
                     <div class="py-3 bg-gray-50 border-b">
                        <div class="flex items-center justify-between gap-5">
                           ...
                           <span class="font-semibold"><?= htmlspecialchars($transaction[0]["time"]); ?></span>
                        </div>
                     </div>
                  </div>
               </div>
