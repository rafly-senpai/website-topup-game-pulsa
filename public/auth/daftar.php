...
<body class="w-screen min-h-screen select-none bg-gray-50 cursor-default" style="font-family: 'Zalando Sans';">
   ...
   <div class="max-w-3xl mx-auto min-h-screen bg-white overflow-hidden">
      ...
      <main class="p-5">
         ...
         <form class="bg-white border shadow-md shadow-gray-200 overflow-hidden rounded" action="/app/services/register-process.php" method="post">
            ...
            <div class="p-5">
               <div class="flex flex-col gap-5">
                  <?php if (isset($_SESSION["registerError"])) : ?>
                     <div class="w-fit">
                        <span class="text-red-500"><?= htmlspecialchars($_SESSION["registerError"]); ?></span>
                     </div>
                     <?php unset($_SESSION["registerError"]); ?>
                  <?php endif; ?>
                  <div class="flex flex-col gap-3">
                     <input class="p-3 bg-white border outline-none rounded" type="text" name="nameInput" placeholder="Masukkan nama" required>
                  ...
                  <button class="text-white p-3 bg-[#2a005c] rounded cursor-pointer" type="submit">Daftar</button>
                  <div class="w-fit flex items-center">
                     <span class="text-gray-500">Sudah punya akun?</span>
                     <a class="hover:underline" href="/public/auth/masuk.php">Masuk</a>
                  </div>
               </div>
            </div>
         </form>
